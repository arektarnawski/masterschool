...
# Main program, selecting the functions to call

# turtle, screen = initialize_turtle()
# letter_a(turtle, color = "red")
# letter_r(turtle)
# letter_e(turtle)
# letter_k(turtle)
# abort_turtle(turtle,screen)

turtle, screen = initialize_turtle(speed=10)
letter_r(turtle)
letter_a(turtle)
letter_k(turtle)
letter_e(turtle)
